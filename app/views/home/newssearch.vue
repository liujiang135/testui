	...
	<transition name="slide">
		<div>
			<w-header class='header'>
				<router-link to="/home" class="button button-icon icon ion-ios-arrow-back" slot="left"></router-link>
				<div slot="title">
					<w-search class='search app-search' v-model="keywords" :on-search="search" placeholder="搜索关键字"></w-search>
				</div>
			</w-header>
			<div class="w-content">
				<!--历史记录-->
